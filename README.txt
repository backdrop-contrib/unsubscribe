...
API Integration
---------------
The unsubscribe module provides an API for modifying module exemptions, overriding email blocking, and reacting to unsubscribe events. 

More information about Unsubscribe's hooks can be found in unsubscribe.api.php file included with this module.

Theming
-------
// @todo. The unsubscribe module allows for the unsubscribe link to me themed via theme_unsubscribe().
